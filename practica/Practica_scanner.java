...
public class Practica_scanner{
    public static void main(String[]args){
        ...
        if(scanner.hasNextLine()){
            System.out.println("el nombre ingresado no es valido o no es una cadena, por favor introduce un nombre valido");
        }
        ...
        System.out.println("hola " + nombre + "!, tienes " + edad + " y tu sueldo es de: " + "$" + sueldo + " pesos.");
    }
}